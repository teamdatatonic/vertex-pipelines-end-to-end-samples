...
generate_statistics = functools.partial(
    notebook_component(
        "generate_statistics",
        "gs://dt-harrycai-sandbox-dev-pipelines/pipelines/training/assets/notebooks/generate_statistics.ipynb",
        input_parameters={
            "use_dataflow": bool,
            "project_id": str,
            "region": str,
            ...
            "file_pattern": str,
            "tfdv_stats_options": dict,
        },
        input_artifacts={"dataset": Dataset},
        output_artifacts={"statistics": Artifact},
        packages_to_install=[
